//
//  buttomView2CollectionViewCell.swift
//  imgchangebybuuton
//
...
class buttomView2CollectionViewCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        ...
        self.uiview1.layer.maskedCorners = [.layerMinXMinYCorner, .layerMaxXMinYCorner]
        //for upper corner curve
